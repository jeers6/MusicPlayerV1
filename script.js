...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
            { time: 33, text: "Look at the stars" },
            { time: 36, text: "Look how they shine for you" },
            { time: 41, text: "And everything you do" },
            { time: 47, text: "Yeah, they were all yellow" },
            { time: 50, text: "I came along" },
            { time: 52, text: "I wrote a song for you" },
            { time: 58, text: "And all the things you do" },
            { time: 63, text: "And it was called 'Yellow'" },
            { time: 69, text: "So then I took my turn" },
            { time: 75, text: "Oh, what a thing to have done" },
            { time: 80, text: "And it was all yellow" },
            { time: 82.5, text: "♫♫♫♫♫" },
            { time: 89, text: "Your skin, oh yeah, your skin, and bones" },
            { time: 94, text: "Turn into something beautiful" },
            { time: 99, text: "And you know, you know I love you so" },
            { time: 108, text: "You know I love you so" },
            { time: 110.5, text: "♫♫♫♫♫" },
            { time: 133, text: "I swam across" },
            { time: 135, text: "I jumped across for you" },
            { time: 141, text: "Oh, what a thing to do" },
            { time: 147, text: "'Cause you were all yellow" },
            { time: 149, text: "I drew a line" },
            { time: 152, text: "I drew a line for you" },
            { time: 157, text: "Oh, what a thing to do" },
            { time: 163, text: "And it was all yellow" },
            { time: 165.5, text: "♫♫♫♫♫" },
            { time: 171, text: "And your skin, oh yeah, your skin, and bones" },
            { time: 177, text: "Turn into something beautiful" },
            { time: 183, text: "And you know, for you, I'd bleed myself dry" },
            { time: 191, text: "For you, I'd bleed myself dry" },
            { time: 194, text: "♫♫♫♫♫" },
            { time: 215, text: "It's true" },
            { time: 218, text: "Look how they shine for you" },
            { time: 224, text: "Look how they shine for you" },
            { time: 235, text: "Look how they shine for" },
            { time: 241, text: "Look how they shine for you" },
            { time: 246, text: "Look how they shine" },
            { time: 249, text: "Look at the stars" },
            { time: 252, text: "Look how they shine for you" },
            { time: 257, text: "And all the things that you do" },
        ],
